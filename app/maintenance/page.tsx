        ...
        <div className="w-full max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="relative bg-black/20 backdrop-blur-sm border border-white/10 rounded-xl p-8 shadow-2xl">
              <h1 className="text-3xl md:text-4xl font-bold text-[#dfae4f] mb-4">Trwają prace techniczne</h1>

              <p className="text-lg md:text-xl mb-6 text-zinc-200">
                Przepraszamy za niedogodności. Nasza strona jest tymczasowo niedostępna z powodu prac konserwacyjnych.
                Wkrótce wrócimy z nowymi funkcjami i ulepszeniami.
              </p>
              ...
              <div className="mb-8">
                ...
                <p className="text-zinc-300">
                  W pilnych sprawach skontaktuj się z nami:
                  <a href="mailto:kontakt@modelarniagdanska.pl" className="text-[#dfae4f] hover:underline ml-1">
                    kontakt@modelarniagdanska.pl
                  </a>
                </p>
              </div>
          ...
          <div className="mt-12 text-sm text-zinc-400">
            <p>© 2023 Modelarnia Gdańska. Wszelkie prawa zastrzeżone.</p>
          </div>
        </div>
      </div>
    </div>
